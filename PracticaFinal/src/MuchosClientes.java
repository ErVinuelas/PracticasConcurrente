...
public class MuchosClientes extends Thread {
	...
	public MuchosClientes(int id, String nombre, String dir, int port, HashMap<String, String> archivos,
	...
	public static void main(String[] args) {
		...
		MuchosClientes mainCliente = new MuchosClientes(101, "main", dir, port, archivos, new ArrayList<String>(),
				numPedirUsuarios, false);
		mainCliente.start();
		for (int i = 1; i <= numClientes; i++) {
			clientes.add(new MuchosClientes(i, Integer.toString(i), dir, port, new HashMap<String, String>(),
					archivosPedir, numPedirUsuarios, false));
		}
		try {
